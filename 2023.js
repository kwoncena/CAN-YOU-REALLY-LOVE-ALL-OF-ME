document.addEventListener('DOMContentLoaded', function () {
    loadTracksForYear(2023); // Load tracks specifically for 2016 when the page is loaded
...
document.getElementById('poem-button').addEventListener('click', async () => {
    const ts = 2023; // Replace this with the actual timestamp or year you want to use
