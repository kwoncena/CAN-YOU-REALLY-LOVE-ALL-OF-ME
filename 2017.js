document.addEventListener('DOMContentLoaded', function () {
    loadTracksForYear(2017); // Load tracks specifically for 2016 when the page is loaded
...
document.getElementById('poem-button').addEventListener('click', async () => {
    const ts = 2017; // Replace this with the actual timestamp or year you want to use
...
document.addEventListener('DOMContentLoaded', function () {
    loadIPAddresses(2017); // Replace 2014 with the year you want to load
});

window.addEventListener('load', function() {
    const selectedYear = 2017; // You can dynamically change this year as needed
